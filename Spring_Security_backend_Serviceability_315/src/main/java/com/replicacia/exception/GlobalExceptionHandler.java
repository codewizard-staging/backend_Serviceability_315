...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	// handleResourceNotFoundException : triggers when there is not resource with the specified ID in DB
	...
	public ResponseEntity<Object> handleResourceExistsException(ResourceExistsException ex) {
		...
		ApiError err = new ApiError(LocalDateTime.now(),HttpStatus.CONFLICT, "Resource Exists" ,details);
